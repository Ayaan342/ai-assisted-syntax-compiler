...
```text
program              → external { external }
external             → function-definition | declaration-statement
...
Function definitions and scalar/array declarations are supported at file scope.
Function prototypes are not part of the current subset.
...
- function prototypes and variadic functions
